					...
					<div class="col-md-10 col-sm-12">
						<div class="billing-address" style="padding-top: 100px; padding-bottom: 100px;">
							<div class="checkout-head">
								<h2>{{ trans('sentence.ЎЗГАРТИРИШ')}}</h2>
							</div>
							<div class="checkout-form">
							    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/edit-product/'.$productDetails->id)  }}" name="add_product" id="add_product" >
            	                   {{ csrf_field() }}
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="product_name" id="product_name"  class="form-control" required="" value="{{ $productDetails->product_name }}">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" name="price" id="price" class="form-control" required="" value="{{ $productDetails->price }}">
										</div>
										<div class="col-md-3">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
						                  ...
						                  @endif
						                  @if(!empty($productDetails->image))
						                  <img style="width: 100px;" src="{{ asset('/images/backend_images/products/medium/'.$productDetails->image) }}"> | <a href="{{ url('/delete-product-image/'.$productDetails->id) }}">Delete</a>
						                  @endif
										</div>
									</div>
									<div class="form-group">
										@php
										   $i = 0;
										@endphp
                                        @foreach($productAltImages as $productaltimages)
                                        @php
										  $i++;
										@endphp
										@if(!empty($productaltimages->image))
										<label class="control-label col-md-2">
											 <sup></sup>
										</label>
										<div class="col-md-5">
							                <img style="width: 100px;" src="{{ asset('/images/backend_images/products/gallery/small/'.$productaltimages->image) }}"> | <a href="{{ url('/delete-alt-image/'.$productaltimages->id) }}">Delete</a>
										</div>
										@endif
                                        @endforeach
									</div>
